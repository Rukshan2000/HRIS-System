...
const Summary = () => {
    ...
    return (
        <AnimatedDiv className="flex justify-between p-4">
            <div className="flex flex-col justify-between p-4 text-blue-800 bg-blue-200 rounded-md shadow-md" style={{ height: '200px', width: '300px' }}>
            ...
            <div className="flex flex-col justify-between p-4 text-green-800 bg-green-200 rounded-md shadow-md" style={{ height: '200px', width: '300px' }}>
            ...
            <div className="flex flex-col justify-between p-4 text-red-800 bg-red-200 rounded-md shadow-md" style={{ height: '200px', width: '300px' }}>
            ...
            <div className="flex flex-col justify-between p-4 text-yellow-800 bg-yellow-200 rounded-md shadow-md" style={{ height: '200px', width: '300px' }}>
